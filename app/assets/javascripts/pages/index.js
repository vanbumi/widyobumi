...
var Index = function () {
    return {
        init: function () {
            ...
            $("#mini-chart-sales").sparkline([8, 3, 1, 5, 4, 8, 9, 6, 5, 7, 10, 5, 8, 9], t), t.tooltipSuffix = "%", $("#mini-chart-brand").sparkline([50, 65, 70, 90, 95, 110, 140, 160, 190, 200, 220, 230, 260], t), $(".gmap").css("height", "220px"), new GMaps({
                div: "#gmap-timeline",
                lat: -33.863,
                lng: 151.202,
                zoom: 15,
